...
class UploadPhotoViewController: UIViewController, UITextViewDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
                    ...
                    linkRef.setValue(dict) { (error, reference) in
                        if let error = error {
                            ...
                            self.alertUser(text: "Upload Completed!", completion: {
                                ...
                                self.commentField.text = "Comment here! Or not."
                            })
                        }
                    }
                }
